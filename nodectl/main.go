...
func main() {
	...
	app.Flags = []cli.Flag{
		cli.StringFlag{Name: "providers, p", Usage: "A comma-separated list of providers ("+strings.Join(common.AvailableProviders, ",")+") to use when managing a cluster (format: 'provider:api-key', e.g.: do:54c4d6e7...,gce:7d63w9r4...)", EnvVar: util.EnvVarConv(app.Name, "providers"),},
